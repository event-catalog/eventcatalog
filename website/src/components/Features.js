...
import { ChatAltIcon, DocumentReportIcon, HeartIcon, CodeIcon, DocumentIcon, ChartBarIcon, UserGroupIcon } from '@heroicons/react/outline';
...
const features = [
  ...
  {
    name: 'Visualise',
    description: 'Visualise your services and events, understand how things connect and how events flow through your Architecture.',
    icon: ChartBarIcon,
  },
  {
          ...
          <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="relative pt-10">
              ...
              <div className="space-y-10">
                <p className="mt-3 text-lg text-gray-500">EventCatalog is designed to help you and your teams document your Event Architecture.</p>
                <p className="mt-3 text-lg text-gray-500">Describe your events with Markdown or use our plugins to do it for you.</p>
              </div>
            </div>
            ...
            <div className="mt-10 -mx-4 relative lg:mt-0 z-20" aria-hidden="true">
              ...
              <img id="markdown-example" width={520} className="z-90 mx-auto shadow-md " src="/img/markdown-example2.png" alt="" />
              <span className="text-right block pr-14 text-sm mt-2 text-gray-900 tracking-wide italic">/events/AddedItemToCart/index.md</span>
            </div>
          </div>

          <Arrow start="markdown-example" startAnchor="bottom" endAnchor="top" end="page-example" zIndex={10} color="#1f2937" />

          <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="relative">
              <img className="w-16 py-8" src="/img/book-mag.svg" alt="Sun icon" />
              <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl">Discover Events</h3>
              <div className="space-y-10">
                <p className="mt-3 text-lg text-gray-500">EventCatalog will render your documents, schemas and can even provide diagrams of how your architecture fits together.</p>
                <p className="mt-3 text-lg text-gray-500">With a list of prebuilt components you can choose what to render for each page.</p>
              </div>
            </div>
            ...
            <div className="mt-10 -mx-4 relative lg:mt-0 z-20" aria-hidden="true">
              ...
              <img id="page-example" width={520} className="z-90 mx-auto shadow-md " src="/img/page-example.png" alt="" />
            </div>
          </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-500">Document, version and stay ontop of your events.</p>
          </div>
