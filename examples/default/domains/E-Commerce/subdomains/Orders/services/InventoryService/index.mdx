...
The Inventory Service API is defined using Protocol Buffers. Below is the complete schema definition:

<ProtoViewer file="schema.proto" title="Inventory Service Proto Schema" maxHeight="600" />
