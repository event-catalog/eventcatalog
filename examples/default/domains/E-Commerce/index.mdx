...
<IcePanel url="https://s.icepanel.io/5OKxXHfTnxxlso/dZkN" title="IcePanel Diagram" description="Here you can find the IcePanel diagram for the E-Commerce domain." />
