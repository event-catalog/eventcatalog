          ...
          generators: [
            [
              '@eventcatalog/generator-asyncapi',
              {
                services: [
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/orders-service.yml',
                  },
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/order-fulfillment-service.yml',
                  },
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/inventory-service.yml',
                  },
                ],
                domain: {
                  id: 'orders',
            ...
            [
              '@eventcatalog/generator-asyncapi',
              {
                services: [
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/payment-service.yml',
                  },
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/fraud-detection-service.yml',
                  },
                ],
                domain: {
                  id: 'payment',
            ...
            [
              '@eventcatalog/generator-asyncapi',
              {
                services: [
                  {
                    path: '/Users/dboyne/dev/eventcatalog/eventcatalog/scripts/__tests__/example-catalog/asyncapi-files/user-service.yml',
                  },
                ],
                domain: {
                  id: 'users',
