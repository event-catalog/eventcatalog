...
import { MagnifyingGlassIcon, ChevronLeftIcon, ChevronRightIcon, ChevronDoubleLeftIcon, ChevronDoubleRightIcon } from '@heroicons/react/24/outline';
        ...
        <div className="w-full md:w-96">
            ...
            {searchQuery && totalResults !== undefined && totalItems !== undefined && (
                <div className="mt-2 text-sm text-gray-500 flex items-center justify-between">
                    <span>
                        Found <span className="font-medium text-gray-900">{totalResults}</span> of <span className="font-medium text-gray-900">{totalItems}</span>
                    </span>
