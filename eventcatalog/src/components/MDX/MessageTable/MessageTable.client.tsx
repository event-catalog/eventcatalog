              ...
              <table className="min-w-full table-fixed divide-y divide-[rgb(var(--ec-page-border))] rounded-sm bg-[rgb(var(--ec-page-bg))]">
                <thead>
                  <tr>
                    ...
                    {showChannels && (
                      <th scope="col" className="w-1/4 px-3 py-3.5 text-left text-sm font-semibold text-[rgb(var(--ec-page-text))]">
                        Channels
                      </th>
                    )}
                  </tr>
                ...
                <tbody className="divide-y divide-[rgb(var(--ec-page-border))]">
                  {paginatedMessages.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={showChannels ? 5 : 4} className="text-center py-4 text-sm text-[rgb(var(--ec-page-text-muted))]">
                        No messages found
                      </td>
                    </tr>
                  )}
