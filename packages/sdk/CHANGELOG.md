...
- c4c5418: Add `getGraph` API to the SDK for traversing resources reachable from a catalog resource (domains, services, messages, channels, entities, flows, ADRs and more), with support for traversal depth and flat or nested output
