...
import { ServerIcon, GlobeAltIcon, ArrowTopRightOnSquareIcon } from '@heroicons/react/24/outline';
import { buildUrl } from '@utils/url-builder';
import { BoxIcon, Group as GroupIcon, Waypoints } from 'lucide-react';
  ...
  return (
    <div className="w-full">
      ...
      <div className="py-4 space-y-8">
        ...
        {/* Empty state */}
        {entities.length === 0 && services.length === 0 && flows.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-[rgb(var(--ec-page-text-muted))]">This system has no entities, services, or flows defined.</p>
          </div>
        )}
      </div>
    </div>
