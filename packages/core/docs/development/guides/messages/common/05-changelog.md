...
keywords:
    - changelog 
    - events
sidebar_label: Message changelogs
title: Event changelogs 
description: Adding changelogs to your events
---

EventCatalog supports changelogs for [domains](/docs/domains), [services](/docs/services) and [messages](/docs/messages).

When you [version a message](/docs/development/guides/messages/common/versioning) in EventCatalog, you can also attach a `changelog.mdx` to that message or versioned message.
