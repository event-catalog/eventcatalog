...
- External services
sidebar_label: Create an external service
title: Create an external service
description: Model third-party services like Stripe, Twilio, or Snowflake as external services in EventCatalog.
---
...
![Stripe rendered as an external service in the EventCatalog visualiser](./img/services/external-system-stripe.png)
