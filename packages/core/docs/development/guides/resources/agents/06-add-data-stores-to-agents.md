...
- writesTo readsFrom
sidebar_position: 6
sidebar_label: Add data stores to agents
...
[Data stores](/docs/development/guides/resources/data/introduction) are containers that hold data in your architecture — databases, caches, object stores, search indexes, and so on. Agents can read from and write to these containers, and documenting those relationships keeps the full data-access picture visible in the visualiser.
