...
Inputs represent the source dependencies your data product consumes. In EventCatalog these can be [events](/docs/development/guides/resources/messages/message-types/events), commands, queries, [services](/docs/development/guides/resources/services/introduction), [data stores](/docs/development/guides/resources/data/introduction), or [channels](/docs/development/guides/resources/messages/message-channels/introduction).
...
- [Add schema contracts](/docs/development/guides/resources/data-products/contracts)
