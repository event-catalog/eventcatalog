...
- domain messages
sidebar_label: Add messages to domains
title: Add messages to domains
description: Document event flows at the domain level.
---

import AddedIn from '@site/src/components/MDX/AddedIn';

Adding [messages](/docs/development/guides/resources/messages/what-are-messages) to your domains allows you to document which messages are published and consumed by your domain.
