...
When you [version a domain](/docs/development/guides/domains/versioning-and-changelogs/versioning) in EventCatalog, you can also attach a `changelog.mdx` to that domain or version.
