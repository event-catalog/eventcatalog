...
7. ### Next steps
   - Learn about [domains](/resources/domains/), [services](/resources/services/), [messages](/resources/messages/), and [channels](/resources/channels/)
   - Import from [AsyncAPI](/guides/import-from-asyncapi/) or [OpenAPI](/guides/import-from-openapi/) specs
   - [Import from an existing EventCatalog](/guides/import-from-eventcatalog/)
   - [Export your model to EventCatalog](/guides/export-to-eventcatalog/)
   - Use the [VSCode extension or CLI](/tooling/editors/) for a local workflow
