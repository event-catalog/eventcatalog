...
const initialElements = [
  {
    ...
    data: {
      ...
      event: 'UserCreated',
      version: '0.0.1',
      description: 'Event is created when the user logs into the account.',
    },
    position: { x: 500, y: 80 },
  },
  {
    ...
    data: {
      ...
      description: 'Service that can do something interesting',
    },
    position: { x: 0, y: -100 },
  },
  {
    ...
    data: {
      ...
      tags: [{ label: 'NodeJS', color: 'green' }],
      description: 'Internal customer portal app used by customer support',
    },
    position: { x: 0, y: 100 },
  },
  {
    ...
    data: {
      ...
      tags: [{ label: 'NodeJS', color: 'green' }],
      description: 'Company Email platform',
    },
    position: { x: 1000, y: 0 },
    animated: true,
  },
