...
const SubscribeNode = ({ data: { serviceName, description, tags = [], version, showWarning } }) => {
  return (
    <div className=" bg-white border-2 p-2 px-4 w-96 text-left shadow-md relative">
      ...
      <Handle
        ...
        onConnect={(params) => console.log('handle onConnect', params)}
      ></Handle>
      <div className="uppercase text-gray-500 text-xs mb-4">Consumer</div>
      <div className="text-gray-700 font-bold">{serviceName}</div>
