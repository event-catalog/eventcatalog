...
export default function EventView({ name, version, lastModifiedDate, children, domains = [], owners = [], summary, producers = [], consumers = [] }) {
                      ...
                      <div className="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
                        <div>
                          <h1 className="text-2xl font-bold text-gray-900 relative">
                            {name}
                            <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium -top-0.5 relative bg-yellow-100 text-yellow-800">v{version}</span>
                          </h1>
                        </div>
                          ...
                          return (
                            <li className="inline">
                              <a href="#" className="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5">
                                ...
                                <div className="ml-3.5 text-sm font-medium text-gray-900">{producer.id}</div>
                              </a>{' '}
                            </li>
                          );
                        })}
                          ...
                          return (
                            <li className="inline">
                              <a href="#" className="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5">
                                ...
                                <div className="ml-3.5 text-sm font-medium text-gray-900">{consumer.id}</div>
                              </a>{' '}
                            </li>
                          );
                        })}
